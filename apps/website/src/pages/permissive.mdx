...
metaDescription: Details about the @license-cop/permissive base config and how to install and set it up in your project.
---

import Permissive from "../components/Permissive.astro";
